import unittest
from solution import closest_neighbor

class TestClosestNeighbour(unittest.TestCase):
    def test_no_neighbour(self):
        strArr = ['000', '100', '000']
        self.assertEqual(0, closest_neighbor(strArr))
    ...
    def test_3by3_matrix(self):
        strArr = ['000', '100', '200']
        self.assertEqual(1, closest_neighbor(strArr))

    def test_4by4matrix(self):
        strArr = ['0000', '2010', '0000', '2002']
        self.assertEqual(2, closest_neighbor(strArr))
